...
export default function Navbar({user}) {
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                'relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm w-max font-medium transition-colors duration-200 ease-out'
                              )}
                            >
                              {category.name}
                            </Popover.Button>
  ...
  <input type="text" class="px-4 py-2 border  text-black border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 w-full" placeholder="Search..." />
                ...
                <button
                  type="button"
                  className="rounded-full mx-5 bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
